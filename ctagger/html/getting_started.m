%% CTAGGER: Getting Started
%
%% Acknowledgements
% The CTAGGER toolkit is being developed as part of the Army Research Laboratories
...
%
%% Overview
% In scientific experiments using event-rich environments, the need for a 
% common method of annotation is critical for data sharing and the 
% application of data mining and machine learning techniques across 
% multiple studies. An event in this context refers to a labeled 
% occurrence that happens at a particular point in time. Events have 
% a type or label, which may be common to multiple events or occurrences. 
% In some representations, events have both starting and ending times. 
% Other representations define separate events at the starting and 
% ending times of incidents that have finite duration. An example of an 
% event-rich scientific environment is real-time monitoring to capture 
% brain and body data during active behavior using multi-channel EEG, 
% eye tracking, and motion capture.
%
% CTAGGER provides an infrastructure for annotating EEG and other
% data using the concept of semi-structured tagging. The user starts with
% a hierarchy of that has been acquiredprovides a visualization tools and a development infrastructure
