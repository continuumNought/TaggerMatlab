...
fprintf('\nIt should return directory and paths when okay button is pressed\n');
fprintf('SET DIRECTORY PATH TO DIRECTORY CONTAINING .SET FILES TO BE TAGGED\n');
fprintf('SET SAVE DIRECTORY FOR GENERATED MAP\n');
