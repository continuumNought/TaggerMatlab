...
values.hedfile = 'HED Specification 1.21.xml';
...
controller4 = char(edu.utsa.tagger.controller.Controller.showDialog(HEDXML, ''));
...
controller5 = char(edu.utsa.tagger.controller.Controller.showDialog(HEDXML, ''));
