...
e1.mergeEventTags('', 'TagsOnly');
eEvents = e1.getEvents();
assertEqual(length(eEvents), 2);
e1.mergeEventTags('', 'Merge');
eEvents = e1.getEvents();
assertEqual(length(eEvents), 2);
fprintf('It should not include extra events if tagsOnly is true\n');
[h3, b3] = eventTags.split([';' values.baseList3], false);
b3 = eventTags(h3, b3);
e1.mergeEventTags(b3, 'TagsOnly');
eEvents = e1.getEvents();
assertEqual(length(eEvents), 2);
fprintf('It should include extra events if tagsOnly is false\n');
...
eT2.mergeEventTags(b1, 'TagsOnly');
...
eT3.mergeEventTags(b1, 'TagsOnly');
