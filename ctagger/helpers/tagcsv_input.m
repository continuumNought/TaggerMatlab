...
%
function [CSVFile, baseMap, dbCredsFile, preservePrefix, ...
...
uiwait(inputFig);
    ...
    function createBrowsePanel(parent)
        ...
        uicontrol('Parent', fBox, ...
            ...
            'HorizontalAlignment', 'Right');
        csvCtrl = uicontrol('Parent', fBox, 'Style', 'edit', ...
            'BackgroundColor', 'w', 'HorizontalAlignment', 'Left', ...
            'Tag', 'CSVEdit', 'String', '', ...
            'TooltipString', ...
            'CSV file name', ...
            'Callback', {@csvCtrlCallback});
        ...
        uicontrol('Parent', fBox, ...
            ...
            'Callback', {@browseCSVCallback, csvCtrl, ...
    ...
    function createRewriteGroup(parent)
        % Create the button panel on the side of GUI
        panel = uiextras.Panel('Parent', parent, 'Title', ...
            'Specify the CSV file columns:', 'Padding', 5);
        bBox = uiextras.Grid('Parent', panel, ...
            'Tag', 'UpdateGrid', 'Spacing', 0);
        uicontrol('Parent', bBox, ...
            'Style','text', 'String', 'Events columns', ...
            'HorizontalAlignment', 'Right');
        eventCtrl = uicontrol('Parent', bBox, 'Style', 'edit', ...
            'BackgroundColor', 'w', 'HorizontalAlignment', 'Left', ...
            'Tag', 'CSVEdit', 'String', '0', ...
            'TooltipString', ...
            'Event columns', ...
            'Callback', {@csvCtrlCallback});
        set(bBox, 'ColumnSizes', 50, 'RowSizes', [0, 30, 30, 30]);
    ...
    function csvCtrlCallback(hObject, eventdata) %#ok<INUSD>
        % Callback for user directly editing directory control textbox
        csv = get(hObject, 'String');
        if exist(csv, 'file')
            CSVFile = csv;
        else  % if user entered invalid directory reset back
            set(hObject, 'String', CSVFile);
        end
    end % dirCtrlCallback
