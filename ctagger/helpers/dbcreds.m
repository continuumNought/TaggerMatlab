...
uiwait(inputFig);
    ...
    function createBrowsePanel(parent)
        ...
        uicontrol('Parent', fBox, ...
            ...
            'TooltipString', ...
            'Press to find file name for saving credentials', ...
    ...
    function createPropertiesPanel(parent)
        ...
        uicontrol('Parent', bBox, 'Style', 'edit', ...
            ...
            'TooltipString', ...
            'URL of database server (or localhost for this machine)');
        uicontrol('Parent', bBox, 'Style', 'edit', ...
            'BackgroundColor', 'w', 'HorizontalAlignment', 'Left', ...
        ...
        set(bBox, 'ColumnSizes', [80, -1], 'RowSizes', ...
            [30, 30, 30, 30, 30]);
    end % createOptionsGroup

    function browseSavePropsCallback(src, eventdata, savePropsCtrl, ...
            myTitle) %#ok<INUSL>
    ...
    function okayCallback(~, ~, infig, passObj) %#ok<INUSD>
        if isempty(configPath)
            warning('dbcreds:NoSaveFile', ...
                ['Give a file name in order to create file or Press' ...
                ' Cancel\n']);
            return;
        end
    ...
    function savePropsCtrlCallback(hObject, eventdata, ...
