...
%
% eTags = eventTagsGroup(hedString, events, 'key1', 'value1', ...)
%
%
...
%
%   'TypeField'        String giving the name of the type field
%                      represented by this object (default is 'type').
%
...
classdef eventTags < hgsetget
    ...
    properties (Access = private)
        ...
        TypeField            % Field name that these tag types corresond to
    ...
    methods
       ...
       function typeField = getTypeField(obj)
            % Return this object in structure form
    ...
    methods(Static = true)
        ...
        function parser = getParser()
            ...
            parser.addParamValue('TypeField', 'type', ...
                @(x) (~isempty(x) && ischar(x)) == 1);
        end % getParser
